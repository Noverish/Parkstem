...
public class LongTicketPurchaseView extends LinearLayout {
    public LongTicketPurchaseView(Context context, ServerClient.Ticket ticket, ServerClient.TicketBuyList ticketBuyList) {
        ...
        try{
            inflater.inflate(R.layout.long_ticket_purchase_item, this);

            ServerClient.ParkInfo parkInfo = ServerClient.getInstance().parkInfo(ticket.local_id);

            TextView name = (TextView) findViewById(R.id.long_ticket_purchase_item_name);
            name.setText(ticket.ticket_name);

            name = (TextView) findViewById(R.id.long_ticket_purchase_item_place);
            ...
            name = (TextView) findViewById(R.id.long_ticket_purchase_item_start_date);
            name.setText(date);
            ...
            name = (TextView) findViewById(R.id.long_ticket_purchase_item_end_date);
            name.setText(date);
